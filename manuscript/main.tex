...
\begin{equation}
  ...
  R_\mathrm{soft}(Z) 
  = 
  \lambda_\mathrm{spline} 
  \frac{1}{2} \left\|\Delta Z\right\|_2^2
  +
...
\begin{equation}
  ...
  \lambda_\mathrm{TV} 
  \left(
    \alpha_\mathrm{TV}\left\|\Delta Z\right\|_1 + \frac{(1-\alpha_\mathrm{TV})}{2}\left\|\Delta Z\right\|_2^2
  \right) .
\end{equation}
The TV terms control the smoothness of solutions, 
and the rank term allows us to recover low-rank solutions.
The function $R_\mathrm{indep}$ is convex; 
therefore we have a convex optimization problem.
